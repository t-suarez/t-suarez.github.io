var data = { results: [ 
  ...
  for(var i = 0; i < data.results.length; i++){
  console.log("Name: " + data.results[i].animal[0].toUpperCase() + data.results[i].animal.substr(1));
  }
  ...
  for(var i = 0; i < data.results.length; i++){
  console.log("Name: " + data.results[i].animal[0].toUpperCase() + data.results[i].animal.substr(1) + ", Legs: " + data.results[i].numberOfLegs);
  }
  ...
  for(var i = 0; i < data.results.length; i++){
  newArr.push({
    "Name": data.results[i].animal[0].toUpperCase() + data.results[i].animal.substr(1),
  ...
  fishMatches = []; //clearing array for the exercise
